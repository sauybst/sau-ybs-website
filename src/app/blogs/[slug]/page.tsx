...
export async function generateMetadata(
    ...
    const { data: event } = await supabase
        .from('blogs')
        .select('title, description, cover_image_url') // image_url sende cover_image falan olabilir, kendi sütun adını yaz
        .eq('slug', params.slug)
        .single()
    ...
    return {
            ...
            images: [
                {
                    ...
                    url: event.cover_image_url || 'https://sauybst.com/og-default.jpg',
                    width: 1200,
                    height: 630,
                    alt: event.title,
                }
        ...
        twitter: {
            ...
            title: event.title,
            description: cleanDescription,
            images: [event.cover_image_url || 'https://sauybst.com/og-default.jpg'],
        }
    }
}
